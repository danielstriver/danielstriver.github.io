    ...
    <div class="row">
        <div class="col-md-12 jumbotron">
            <div class="text-center">
                <h2>Computerized Student Organization NEW LIFE CHRISTIAN ACADEMY</h2>
<h3> DEVELOPER: DIEU THEBLACKHAT (SCEINCE CLUB)</h3>
                <p>
                    <h1>Voting System</h1><br />
                <button class="btn btn-info"> Learn About the System</button>
                </p>
            </div>
        </div>
    </div>
